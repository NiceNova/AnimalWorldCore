    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Animal[] NatureList = { new NeedleBelly(), new BeakTail(), new DesertRedBally(), new YellowShel(), new ClaweAdngleTooth(), new SpikeSwordBearer(), new GillsSnout(), new TailSnout() };
                ...
                Animal attacking = NatureList[rand.Next(NatureList.Length)];
                Animal defending = NatureList[rand.Next(NatureList.Length)];
